  ...
  return (
    ...
    <div className="relative text-white">
      ...
      <div className="relative text-white">
        ...
        <img
          className="md:p-15 absolute top-0 z-20 mx-20 my-20 h-auto max-w-6xl rounded-lg"
          src="https://s3-alpha-sig.figma.com/img/70d3/55f7/4980cb8143e79b5cefaa7af0850ab4d7?Expires=1718582400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=Bx1q4ZhU6v83pQY1lrQ4hq~thmIUc-SAYKulDFjAGoSvRxaEKFZzVKhaff9PYB4YC25TfFN~17apCJzWhsvVxkkznrvZXLwF6UvqHbmFyibYO5aGGTKlphBxha0pXTvZdf2MG-Bx3HOr7EnuEM0jRQfrcIdrJbW98hTXjc8oY4so9QN9NYnXWdix5e-Ec5twAixvjNv91HloevjxdlvVf2xhxxfQohwztPUPhbw8jEHCeci5ACPG-kwAu5DyFQW0yWAAti-7d5ZT6TDFlcbIq84OkfppJkaY9rpEGxyR3XpzcGs4vmZmeOG9bcmLkLMS~OCzItKgCah0PFm2Fb84Lg__"
          alt=""
        />
        <div>
          ...
          <div className="absolute left-0 top-20 z-30 mx-5 my-20 h-auto rounded-lg font-poppins md:p-20 ">
            ...
            <p className="ml-10 max-w-80 text-left text-2xl">
              ...
              consciente seja a norma, não a exceção. Oferecemos uma seleção
              curada de produtos sustentáveis que ajudam a reduzir o impacto
              ambiental e promovem um futuro mais saudável para todos. Junte-se
              a nós nessa jornada para uma economia verde e descubra como cada
              compra pode fazer a diferença.
            </p>
          </div>
        </div>
      </div>
